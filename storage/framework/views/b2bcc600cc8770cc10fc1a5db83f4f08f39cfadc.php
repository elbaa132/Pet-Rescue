...
<html lang="en">
  ...
  <?php echo $__env->make('sweetalert::alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <header class="sticky-top">
      ...
      <a class="about" href="<?php echo e(url('get_aboutUs')); ?>">About Us</a>
      <a class="adoption" href="<?php echo e(url('get_adoption')); ?>">Adoption</a>
            ...
            <form class="row g-3">
                ...
                <select id="inputHewan" class="form-select" name="jenis_hewan">
                    <?php $__currentLoopData = $hewan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($h->id_hewan); ?>"><?php echo e($h->jenis_hewan); ?> - <?php echo e($h->nama_hewan); ?></option>
...
<?php /**PATH C:\laravel\petRescue\resources\views/formAdopt.blade.php ENDPATH**/ ?>